        ...
        <div className="product-details-info">
          ...
          <p className="ratings">
            ...
            {Array.from({ length: 5 }, (_, i) => (
              <FiStar
                key={i}
                color={i < Math.round(product.ecoScore) ? "#FFD700" : "#ccc"}
              />
            ))}{" "}
            ({product.ecoScore} / 5)
          </p>
          ...
          <p>
            <strong>Eco Score Bar: </strong>
          </p>
          <div className="eco-score-bar">
            <div
              className="eco-fill"
              style={{ width: `${(product.ecoScore / 5) * 100}%` }}
            ></div>
          </div>
          ...
          <div className="carbon-chart">
            ...
            <div className="chart-bar">
              <div
                ...
                style={{
                  width: `${
                    (product.materialCO2 /
                      (product.materialCO2 + product.shippingCO2)) *
                    100
                  }%`,
                }}
              >
            ...
            <p>
              <strong>Total:</strong>{" "}
              {product.materialCO2 + product.shippingCO2} kg CO₂
            </p>
          </div>
