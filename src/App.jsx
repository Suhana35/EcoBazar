...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/productInfo/:productId" element={<ProductDetails addOrder={addOrder} products={products} />} />
      <Route path="/orders" element={<OrderHistory orders={orders} />} />
      <Route path="/cart" element={<ProductCart cartItems={cartItems} setCartItems={setCartItems} addOrder={addOrder} products={products}/>} />

      <Route path="/selAddProduct" element={<AddProduct products={products} setProducts={setProducts} />} />
      <Route path="/selProducts" element={<ProductCatalog products={products} />} />
      <Route path="/seller" element={<SellerDashboard />} />
      <Route path="/salesOrders" element={<SalesOrders ordersProp={orders.map((o, idx) => ({
        id: idx + 1,
        product: { name: o.name, price: o.price, carbonFootprint: o.footprint },
        buyer: { name: "Unknown", email: "unknown@example.com" },
        quantity: o.quantity || 1,
      }))}
      />
      }
      />
      <Route path="/carbonReports" element={<CarbonReports orders={orders} />} />
