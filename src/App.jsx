...
function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/cart" element={<ProductCart cartItems={cartItems} setCartItems={setCartItems} onCheckout={handleCheckout} />} />

      <Route path="/selAddProduct" element={<AddProduct setProducts={setProducts} />} />
